...
#Con rutas para Linux
#enviar_mensaje("Correo con adjunto", "Hola te envio un correo con adjunto", "mvaldeza2@miumg.edu.gt", "No tengo titulo", "adjunto_para_enviar.txt", "/home/mvaldez/Documents/UMG/Algoritmos/2025/clase12")

#Con rutas para Windows
#enviar_mensaje("Correo con adjunto", "Hola te envio un correo con adjunto", "mvaldeza2@miumg.edu.gt", "No tengo titulo", "adjunto_para_enviar.txt", "C:\\Users\mvaldez\Desktop\")
